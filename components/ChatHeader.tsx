...
interface ChatHeaderProps {
  user: UserProfile; // The profile of the user being chatted with
  onVideoCall?: () => void; // Optional callback for starting a video call
}

/**
 * ChatHeader Component
 *
 * Displays the header section of a chat window.
 * Includes:
 *  - A back button to return to the previous page
 *  - The other user's avatar, name, age, and username
 *  - A video call button (if provided)
 */
