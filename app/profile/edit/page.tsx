          ...
          >
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-pink-100 text-pink-700 rounded-lg hover:bg-pink-200 transition cursor-pointer"
                  >
                    Use My Location
                  </button>
                </div>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-200">
              <button
                type="button"
                onClick={() => router.back()}
                className="px-6 py-2 text-gray-700 hover:text-gray-900 transition-colors duration-200 cursor-pointer"
              >
                Cancel
              </button>
              <button
