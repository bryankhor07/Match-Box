...
export default function AuthPage() {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 via-pink-200 to-red-100">
      <div className="max-w-md w-full space-y-8 p-8 bg-white/80 rounded-2xl shadow-xl">
        {/* App title and subtitle */}
        <div className="text-center">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-red-500 bg-clip-text text-transparent mb-2">
            MatchBox
          </h1>
        ...
        <form className="space-y-6" onSubmit={handleAuth}>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-2xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500"
